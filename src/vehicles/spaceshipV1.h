...
volatile int startVolumePercentage = 0; // Adjust the start volume (usually = 100%)
...
#include "sounds/spaceshipV1Idle.h" // VW Beetle / Käfer
...
volatile int dieselKnockVolumePercentage = 20; // Adjust the Diesel knock volume (usually = 200 - 600%) 50
...
volatile int fanStartPoint = 10; // Volume will raise above this point (250 for Tatra 813)
